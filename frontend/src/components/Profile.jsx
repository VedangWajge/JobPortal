            ...
            <div className='max-w-4xl mx-auto bg-white border border-gray-200 rounded-2xl my-5 p-8'>
                <div className='flex justify-between'>
                    ...
                    <div className='flex items-center gap-4'>
                        ...
                        <div>
                            <h1 className='font-med text-xl'>{user?.fullname}</h1>
                ...
                <div className='my-5'>
                    ...
                    {
                        user?.profile?.skills.length !== 0 ? user?.profile?.skills.map((item, index) => <Badge variant="outline" key={index}>{item}</Badge>) : <span>NA</span>
                    }
                </div>
